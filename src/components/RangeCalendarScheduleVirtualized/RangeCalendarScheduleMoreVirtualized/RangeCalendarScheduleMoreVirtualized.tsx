...
export const RangeCalendarScheduleMoreVirtualized = () => {
    ...
    const {more, onChangeMore, bordered, scrollLeft, scrollTop, headerHeight} = useRangeCalendarScheduleVirtualized();
            ...
            >
                ...
                >
                    <div style={{padding: 5}}>
                        ...
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. A aperiam autem, delectus doloribus
                        ducimus ea eos eveniet explicabo id, in placeat praesentium quae quasi quo reprehenderit saepe
                        sequi unde veniam.
                    </div>
                    <div
                        style={{
