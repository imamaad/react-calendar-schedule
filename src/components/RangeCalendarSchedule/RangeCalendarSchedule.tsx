...
import {rangeBuildCalendar} from "./rangeBuildCalendar";
...
export const RangeCalendarSchedule: React.FC<RangeCalendarScheduleInitialInterface> = (props) => {
    const {bgColorHeader, format, startDate, titleColumns = "", columns = [], changeStartDate, size, dataSource} = props;
    ...
    const getDays = (day: any, length: any, direction: any = directionDrag) => {
        ...
        return rangeBuildCalendar(day, next, length);
    };
